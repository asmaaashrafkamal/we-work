    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown"> <span> We Work Group </span></h2>
          <h3 class="animate__animated animate__fadeInUp">We Are Creative </h3>
          <a href="portfolio.php" class="btn-get-started animate__animated animate__fadeInUp">Read More</a>
        </div>
      </div>
  ...
  if($i % 2==0){
       echo'<div class="row" data-aos="fade-up">
          ...
          <div class="col-md-7 pt-4">
            ...
            echo'
              <i class="icofont-check"></i>'.$po['point'].'<br>
          ';}
            echo'</ul>';
          }
            echo'
