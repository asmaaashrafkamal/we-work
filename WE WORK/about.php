      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3 style="color: rgb(19, 19, 141);">The #1 Job Board for Hiring Designers and Creative Professionals.</h3>
      <br> <br> <br>
            <ul>
              ...
              <li><i class="icofont-check-circled"></i>"User Training Services".</li>
            </ul>
          </div>
        </div>
